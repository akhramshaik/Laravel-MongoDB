          ...
          <div class="widget widget-nopad">
            ...
            <div class="widget-content">
              <div class="widget big-stats-container">
                ...
                <button class="btn btn-primary"><a style="color: white;" href="<?php echo e(URL::to('job_apply')); ?>">Apply for Jobs</a></button>
                </div>
                </div>
                <!-- /widget-content --> 
...
<?php echo $__env->make('jobportal.user-main', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>