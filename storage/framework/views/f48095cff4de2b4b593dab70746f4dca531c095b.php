        ...
        <div class="span12">
          ...
          <div class="widget">
            ...
            <div class="container" style="    margin: 10px;">
                            <form id="upform" action="<?php echo e(URL::to('/process_form_data')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden"  name="post_job_id" class="form-control" value="<?php echo e($job_id); ?>" >
...
<br>
   ...
   <button class="btn btn-danger"><a style="color: white;" href="<?php echo e(URL::to('job_apply')); ?>">Back to Jobs</a></button>
