...
<div class="main">
  <div class="main-inner">
   ...
   <button class="btn btn-danger"><a style="margin: 20px;color: white;margin: 20px;" href="{{ URL::to('admin_list') }}">Back</a></button>
